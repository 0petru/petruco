...
export const BeforeAfterSection: React.FC = () => {
  const [activeTab, setActiveTab] = useState<"both" | "before" | "after">(
    "both",
  );
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="mt-4 text-slate-600 text-base sm:text-lg leading-relaxed">
            Ce experimentează o persoană în momentul în care îți tastează numele
            pe Google:
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-10">
          ...
          >
            ...
            <div>
              ...
              {/* Checklist Items */}
              <ul className="space-y-3.5 mb-6 text-xs sm:text-lg text-slate-600">
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-red-100 text-red-600 flex items-center justify-center font-bold text-sm shrink-0 mt-0.5">
                    ✕
                  </div>
                  <span>
                    ...
                    Lipsesc specializările, onorariile sau tipul de
                    psihoterapie.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    O pagină de Facebook abandonată din 2019 sau forumuri
                    medicale vechi.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong className="text-slate-900 font-semibold">
                      Fără website profesional:
                    </strong>{" "}
                    Niciun spațiu dedicat unde persoana să înțeleagă atmosfera
                    cabinetului.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    Nu este clar dacă mai primești pacienți noi sau unde
                    profesezi exact.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    Niciun buton direct de programare, doar telefoane fără orar.
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="mt-4 p-4 rounded-xl bg-red-50/60 border border-red-200/60 text-md text-red-900">
              <div className="uppercase font-bold text-red-700 tracking-wider mb-1 text-md">
                Efect psihologic:
              </div>
              <p className="italic leading-relaxed">
                Persoana se simte nesigură dacă ești disponibil, ezită să sune
                și își continuă căutarea pe Google către următorul psiholog
                recomandat.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              {/* Checklist Items */}
              <ul className="space-y-3.5 mb-6 text-xs sm:text-lg text-slate-700">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    Modern, securizat, optimizat pe mobil și cu design primitor.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-teal-100 text-teal-700 flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">
                  ...
                  <span>
                    ...
                    Acreditări COPSI, experiență clinică și valorile tale
                    terapeutice.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    Fiecare tip de intervenție (individuală, cuplu, evaluare)
                    explicat simplu.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong className="text-slate-900 font-semibold">
                      Google Maps optimizat:
                    </strong>{" "}
                    Pin precis, fotografii din cabinet, orar actualizat și
                    recenzii.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong className="text-slate-900 font-semibold">
                      Modalitate simplă de contact:
                    </strong>{" "}
                    Buton de WhatsApp, apel direct și formular confidențial.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-teal-100 text-teal-700 flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">
                  ...
                  <span>
                    ...
                    Ghid pas cu pas despre cum decurge prima ședință.
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="mt-4 p-4 rounded-xl bg-teal-50/70 border border-teal-200/80 text-md text-teal-900">
              <div className="text-md uppercase font-bold text-teal-700 tracking-wider mb-1">
                Efect psihologic:
              </div>
              <p className="italic leading-relaxed font-medium">
                Persoana simte siguranță și profesionalism încă din primul
                moment și trimite direct solicitarea de programare.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-14 mx-auto text-center">
          <div className="p-8 sm:p-12 rounded-3xl bg-slate-900 text-white shadow-2xl border border-slate-800 relative overflow-hidden">
            ...
            <blockquote className="text-xl sm:text-2xl lg:text-3xl font-extrabold leading-snug text-white">
              „Prima impresie nu începe atunci când intra în cabinet.
              <br />
              <span className="text-teal-400 font-bold">
                Pentru mulți oameni, începe înainte,{" "}
                <span className="underline">atunci când vă caută online.</span>
              </span>
            </blockquote>
          </div>
        </div>
