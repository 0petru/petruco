    ...
    <section className="py-16 sm:py-24 bg-white border-b border-slate-200/80">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mx-auto mb-14 max-w-3xl">
          ...
          <div className="mt-4 text-base sm:text-xl text-slate-600 leading-relaxed space-y-1">
            <p>Un website singur, izolat, nu este suficient.</p>
            <p>Poți avea cel mai elegant website din lume.</p>
            <p className="text-teal-700 font-semibold">
              Dar dacă nimeni nu te găsește în căutare sau pe hartă, conexiunea
              se pierde.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 rounded-3xl border border-slate-800 p-6 sm:p-10 text-white shadow-2xl relative overflow-hidden mb-12">
          <div className="text-center mb-8 border-b border-slate-800 pb-4">
            <span className="text-2xl uppercase tracking-wider text-teal-400 font-mono font-semibold">
              Traseul Complet al Potențialului Client
            </span>
          </div>

          <div className="flex flex-col items-center max-w-2xl mx-auto">
            {/* Step 1: Persoana Cauta */}
            <div className="w-full max-w-xs text-center p-3.5 rounded-xl bg-slate-800 border border-slate-700 text-white font-bold text-md uppercase tracking-wider shadow-sm">
            ...
            <div className="w-full grid grid-cols-3 gap-3 sm:gap-4 my-2">
              <div className="p-3.5 rounded-xl bg-slate-800/90 border border-slate-700 text-center flex flex-col items-center justify-center shadow-xs">
                <Search className="w-8 h-8 text-teal-400 mb-1.5" />
              ...
              <div className="p-3.5 rounded-xl bg-slate-800/90 border border-slate-700 text-center flex flex-col items-center justify-center shadow-xs">
                <MapPin className="w-8 h-8 text-teal-400 mb-1.5" />
                <span className="text-md font-bold text-white">MAPS</span>
                <span className="text-[11px] text-slate-400 hidden sm:block mt-0.5">
                  Locație &amp; Recenzii
                </span>
              </div>
              <div className="p-3.5 rounded-xl bg-slate-800/90 border border-slate-700 text-center flex flex-col items-center justify-center shadow-xs">
                <Globe className="w-8 h-8 text-teal-400 mb-1.5" />
                <span className="text-md font-bold text-white">WEBSITE</span>
                <span className="text-[11px] text-slate-400 hidden sm:block mt-0.5">
                  Servicii &amp; Terapie
                </span>
              </div>
            ...
            {/* Step 4: Trust */}
            <div className="w-full max-w-xs text-center p-3.5 rounded-xl bg-slate-800 border border-teal-500/50 text-teal-300 font-bold text-md uppercase tracking-wider flex items-center justify-center gap-2 shadow-xs">
            ...
            {/* Step 5: Contact */}
            <div className="w-full max-w-md text-center p-4 rounded-xl bg-teal-600 text-white font-bold text-md uppercase tracking-wider shadow-lg shadow-teal-600/30 flex items-center justify-center gap-2">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200/90 shadow-xs">
            ...
            <p className="text-xs text-slate-600 leading-relaxed font-normal">
              Informații complete și actualizate despre tine atunci când te
              caută după nume sau specializare.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200/90 shadow-xs">
            ...
            <p className="text-xs text-slate-600 leading-relaxed font-normal">
              Cabinetul verificat, fotografii calde, orar exact și recenzii
              profesionale organizate respectuos.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200/90 shadow-xs">
            ...
            <p className="text-xs text-slate-600 leading-relaxed font-normal">
              Pacientul înțelege cine ești, care este abordarea ta terapeutică
              și ce tipuri de intervenție oferi.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200/90 shadow-xs">
            ...
            <p className="text-xs text-slate-600 leading-relaxed font-normal">
              Următorul pas fără nicio barieră de comunicare, prin canalul cel
