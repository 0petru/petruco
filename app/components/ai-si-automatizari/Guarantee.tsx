...
const FOR_YOU = [
  "Ai deja clienți și lead-uri care intră pe mai multe canale.",
  "Pierzi lead-uri pentru că răspunsul vine a doua zi, nu în primele minute.",
  "Echipa pierde ore pe întrebări care se repetă la nesfârșit.",
  "Folosești deja un CRM, un calendar sau WhatsApp Business.",
];

const NOT_FOR_YOU = [
  "Nu ai încă lead-uri care intră — întâi are sens un website care le aduce.",
  "Cauți exclusiv cel mai mic preț, indiferent de rezultat.",
  "Vrei un proiect pe 6 luni, cu 40 de ședințe de aliniere.",
    ...
    <Section id="garantie" className="bg-zinc-50/50">
      ...
      >
        ...
        <div className="relative mx-auto max-w-2xl">
          ...
          <h2 className="mt-5 text-2xl font-medium tracking-tight text-zinc-900 sm:text-3xl">
            Garanția „7 zile sau banii înapoi”
          </h2>

          <p className="mt-4 text-sm leading-relaxed text-zinc-600 sm:text-base">
            Dacă în 7 zile lucrătoare de la încheierea apelului sistemul nu este
            funcțional și integrat cu uneltele tale, îți virăm înapoi{" "}
            <strong className="font-semibold text-zinc-900">
              100% din onorariul de configurare
            </strong>
            . Fără întrebări, fără justificări, fără clauze ascunse în contract.
            Riscul e integral al nostru.
          </p>

          <p className="mt-4 text-sm leading-relaxed text-zinc-600 sm:text-base">
            Și după lansare rămânem în joc: dacă în primele 30 de zile sistemul
            nu economisește cel puțin{" "}
            <strong className="font-semibold text-zinc-900">
              20 de ore de muncă manuală
            </strong>
            , continuăm să optimizăm gratuit până se întâmplă.
          </p>
      ...
      <div className="mt-20">
        <SectionIntro
          ...
          description="Automatizarea dă cele mai bune rezultate acolo unde există deja flux de clienți. Iată exact unde ne încadrăm."
        />
