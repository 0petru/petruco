...
export default function App() {
  ...
  const [selectedExample, setSelectedExample] = useState<WebsiteExample | null>(null);
  ...
  return (
    <div className="min-h-screen bg-[#FDFCFB] text-[#1A1A1A] font-sans selection:bg-[#2D5A27] selection:text-white flex flex-col">
      ...
      <main className="flex-1">
        ...
        <CostOfInactionSection onOpenAuditModal={() => setIsAuditModalOpen(true)} />
        ...
        <TestimonialsSection onOpenAuditModal={() => setIsAuditModalOpen(true)} />
